...
def test_todo_items():
    ...
    new_item = Item(1, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "To Do", 12345)
    list = [new_item]
...
def test_doing_items():
    ...
    list.append(Item(2, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "Doing", 12345))
    item_view_model = ViewModel(list)
    #Act
...
def test_done_items():
    ...
    list.append(Item(1, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "To Do", 12345))
    list.append(Item(2, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "Doing", 12345))
    list.append(Item(3, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "Done", 12345))
    list.append(Item(4, "Testing", "A card used for testing", "03/15/2022", "03/15/2022", "Done", 12345))
    item_view_model = ViewModel(list)
    #Act
